...
execute join(['function! vital#_wifi#System#Job#Vim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_wifi#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
